        ...
        chrome.scripting.executeScript(
          ...
          function (result) {
            ...
            if (
              ...
              if (key == "numberOfRatings" || key == "numReviews") {
                extractedHTML = extractNumericalValue(result[0].result[0]);
                ...
                extractedHTML = extractReturnPolicyDays(result[0].result[0]);
                productInfo["returnPolicy"] = extractedHTML;
              } else if (key == "deliveryTime") {
                extractedHTML = calculateDaysDifference(result[0].result[0]);
